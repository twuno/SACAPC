...
public class SQLite extends SQLiteOpenHelper{
    ...
    private static final String tabla_Incidencias="CREATE TABLE `INCIDENCIAS`("+
    											  "`PK_IncidenciaId`INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL,"+
    ...
    private static final String Tabla_Facturas="CREATE TABLE `Facturas` ( " +
    											...
    											"`FK_CasaId` int(11)  NOT NULL UNIQUE, " +
    											...
    											"`Latitud` double(8,6) DEFAULT NULL,"+
    											"`Longitud` double(8,6) DEFAULT NULL,"+
    ...
    private static final String TABLA_INFO = "CREATE TABLE info " +  
            								 ...
            								 " `Latitud` Double(8,6) NOT NULL,"+ //ultima medicion
            								 " `Longitud` Double(8,6) NOT NULL,"+ //ultima medicion
	...
	public int actualizarinfo()
	{
		...
		String Query="select "+
								...
								" md.Serie Medidor,md.Modelo TipoMedidor,md.latitud,md.longitud,F.Fecha FechaAnterior,F.MedicionActual ,"+
								" D.SaldoPendiente Deuda "+" from Conexiones ca "+
	...
	String value,value2=null;
	
	String queryIncidentes="Select * from Incidencias;";
	
	try
	{
		value2=instancia.ejecutarConsultaSQL(false, queryIncidentes, context);
	}catch(Exception e)
	{
	...
	this.droptabla("INCIDENCIAS");
	this.insertarDatos(value2, "INCIDENCIAS");
	
	try{ 
		value=instancia.ejecutarConsultaSQL(false, Query, context);
	}catch(Exception e )
	{
		Toast.makeText(context, e.getMessage(), Toast.LENGTH_LONG).show();
		return -1;
	...
	public int insertarMysql(ArrayList<Object> parametros)
	{
	...
	public ArrayList<Object> LastFactura(String Medidor)
	{
		...
		String[] valores_recuperar={"_id","cuenta","FK_TipoTarifaId","Descripcion","Alcantarillado","NombreCliente","Serie","Modelo","Latitud","Longitud","Fecha","MedicionActual","SaldoPendiente"};
		...
		if (c!=null)
		{
			...
			try{
				...
				data.add(c.getDouble(8));
				data.add(c.getDouble(9));
				data.add(c.getString(10));
				data.add(c.getDouble(11));
				data.add(c.getDouble(12));
				return data;
			}catch(Exception e)
			{
	...
	public ArrayList<Object> LastFacturac(String cuenta)
	{
		ArrayList<Object> data = new ArrayList<Object>();
		SQLiteDatabase db = getReadableDatabase();
		...
		Cursor c =db.query("info", valores_recuperar, "cuenta ='"+cuenta+"'", null, null, null, null);
		if (c!=null)
		{
			c.moveToFirst();
			try{
	...
	public ArrayList<Object> Facturas(String Medidor)
	{
		ArrayList<Object> data = new ArrayList<Object>();
		SQLiteDatabase db = getReadableDatabase();
		String[] valores_recuperar={"_id","cuenta","FK_TipoTarifaId","Descripcion","Alcantarillado","NombreCliente","Serie","Modelo","Fecha","MedicionActual","SaldoPendiente"};
		Cursor c =db.query("info", valores_recuperar, null, null, null, null, null);
		if (c!=null)
		{
			c.moveToFirst();
				do{
	...
	public ArrayList<Object> getFacturas()
	{
		ArrayList<Object> data = new ArrayList<Object>();
		SQLiteDatabase db = getReadableDatabase();
		Cursor c=db.rawQuery("select nombrecliente,cuenta from  info i inner join facturas f on i.cuenta =f.FK_CasaId ",null);
		if (c!=null)
			...
			
		{
			...
			c.moveToFirst();
				...
				do{
					try{
						String[] valores_recuperar={c.getString(0),c.getString(1)};
						data.add(valores_recuperar);
	...
	public ArrayList<String> getIncidencias()
	{
		...
		SQLiteDatabase db = getReadableDatabase();
	//	String[] valores_recuperar={"_id","cuenta","FK_TipoTarifaId","Descripcion","Alcantarillado","NombreCliente","Serie","Modelo","Fecha","MedicionActual","SaldoPendiente"};
		Cursor c =db.query("INCIDENCIAS", null, null, null, null, null, null);
		if (c!=null)
		{
			c.moveToFirst();
				do{
